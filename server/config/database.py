...
health_literacy_analytics_events_collection = db["analytics_events"]
health_literacy_content_collection = db["content"]
sentiment_pulse_surveys_collection = db["surveys"]
sentiment_pulse_survey_responses_collection = db["survey_responses"]
