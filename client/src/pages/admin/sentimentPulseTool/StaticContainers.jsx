  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h3 className="mb-2 text-sm text-gray-500">Sentiment Score</h3>
      ...
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h3 className="mb-2 text-sm text-gray-500">Survey Responses</h3>
        <div className="flex items-end justify-between">
          <div>
            <p className="text-3xl font-bold text-gray-900">
      ...
      {/* Active Regions Card */}
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h3 className="mb-2 text-sm text-gray-500">Active Regions</h3>
        <div className="flex items-end justify-between">
          <div>
            <p className="text-3xl font-bold text-gray-900">
      ...
      {/* Latest Update Card */}
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h3 className="mb-2 text-sm text-gray-500">Latest Update</h3>
